...
const Login: FC<{ userRole: Role }> = ({ userRole }) => {
  ...
  return (
    ...
    //   </div>
    //   <div
    //     className={`login-container mx-auto w-full /50 max-w-lg rounded-xl p-10`}
    //   >
    ...
    //           <div className="mt-2">
    //             <input
    //               className="login-password flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
    //               type="password"
