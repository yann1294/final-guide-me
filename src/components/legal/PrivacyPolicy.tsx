...
Legitimate Interest - Our legitimate interest means your information has a commercial business purpose and is necessary in order to provide a product or service to you and does not override your rights and freedoms as an individual. For example; as a travel customer, we collect your email address for the purpose of communicating with you when necessary to communicate about the product or service you&rsquo;re requesting or booking, and for GUIDEME to provide you with relevant information. If you are a business partner, we may process your contact information in order to manage our relationship with you. We also rely on our legitimate interests to improve our products and services, and to prevent fraudulent activity on our online platforms and accounts (as set out more specifically below). When using personal data to serve our or a third party&rsquo;s legitimate interest, we will always balance your rights and interests in the protection of your personal information against our rights and interests or those of the third party, including by using your information in a way which is proportionate and respects your privacy.
...
We may contact you to seek your interest in taking part in research projects, surveys and interviews. These interactions are designed to help us gain insight and understand certain things such as how to improve the services we provide, help us to understand our customers&rsquo; needs and expectations, what media they consume, what their concerns are, why do they travel, etc. Your information and details from our research activities may be stored or kept on file for future reference if relevant and will be de-identified where possible.
    </p>
    <h1 className="mb-4">
...
Please read the following privacy policy (Privacy Policy) to understand how we use and protect the personal information you provide to us, or we receive and collect when you use our services, including how we collect it, and what we do with it, as well as some of the steps we take to safeguard your personal information.  We hope that this will help you make an informed decision about sharing personal information with us.   
This Privacy Policy may be updated from time to time to keep it up to date with legal requirements and the way we operate our business. You are responsible for reviewing this Privacy Policy periodically and informing yourself of any changes to this Privacy Policy. We suggest that you check back regularly to review any changes. If we make significant changes to this Privacy Policy, we will seek to inform you by notice on our website or email.
We take data protection and privacy seriously at GUIDEME, and we want you to feel secure when you provide us with personal information. This Privacy Policy explains how we use and protect the personal information we receive from you or collect when you use our touristic services. We&rsquo;ll also describe how we gather your personal information and the measures we take to keep it safe.
